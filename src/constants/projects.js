export const projects = [
  {
    name: "MB Peluquería",
    description:
      "Shifts system for a hair salon developed with NextJS, Tailwind, and MongoDB.",
  ...
  },
  {
    name: "Megallón",
    description:
      "Manager system for vegan food place developed with NextJS, Tailwind, Shadcn/ui, Prisma, and NestJS.",
    url: undefined,
  ...
  },
  {
    name: "brg's Shop",
    description:
      "E-commerce developed with React, Redux, Firebase, Bootstrap, and SASS",
    url: "https://brgshop.netlify.app",
